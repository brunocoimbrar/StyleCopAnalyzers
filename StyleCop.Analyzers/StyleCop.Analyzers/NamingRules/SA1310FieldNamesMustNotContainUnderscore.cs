...
namespace StyleCop.Analyzers.NamingRules
{
    ...
    internal class SA1310FieldNamesMustNotContainUnderscore : DiagnosticAnalyzer
    {
        ...
        private static readonly DiagnosticDescriptor Descriptor =
            new DiagnosticDescriptor(DiagnosticId, Title, MessageFormat, AnalyzerCategory.NamingRules, DiagnosticSeverity.Info, AnalyzerConstants.EnabledByDefault, Description, HelpLink);
