...
namespace StyleCop.Analyzers.SpacingRules
{
    ...
    internal class SA1028CodeMustNotContainTrailingWhitespace : DiagnosticAnalyzer
    {
        ...
        private static readonly DiagnosticDescriptor Descriptor =
            new DiagnosticDescriptor(DiagnosticId, Title, MessageFormat, AnalyzerCategory.SpacingRules, DiagnosticSeverity.Error, AnalyzerConstants.EnabledByDefault, Description, HelpLink, WellKnownDiagnosticTags.Unnecessary);
