...
namespace StyleCop.Analyzers.MaintainabilityRules
{
    ...
    internal class SA1412StoreFilesAsUtf8 : DiagnosticAnalyzer
    {
        ...
        private static readonly DiagnosticDescriptor Descriptor =
            new DiagnosticDescriptor(DiagnosticId, Title, MessageFormat, AnalyzerCategory.MaintainabilityRules, DiagnosticSeverity.Error, AnalyzerConstants.DisabledByDefault, Description, HelpLink);
