...
| Property | Default Value | Minimum Version | Summary |
| --- | --- | --- | --- |
| `systemUsingDirectivesFirst` | false | 1.0.0 | Specifies whether `System` using directives are placed before other using directives |
| `usingDirectivesPlacement` | `"outsideNamespace"` | 1.0.0 | Specifies the desired placement of using directives |
| `blankLinesBetweenUsingGroups` | `"omit"` | 1.1.0 | Specifies is blank lines are required to separate groups of using statements |
...
| Property | Default Value | Minimum Version | Summary |
| --- | --- | --- | --- |
| `allowCommonHungarianPrefixes` | **false** | 1.0.0 | Specifies whether common non-Hungarian notation prefixes should be allowed. When true, the two-letter words 'as', 'at', 'by', 'do', 'go', 'if', 'in', 'is', 'it', 'no', 'of', 'on', 'or', and 'to' are allowed to appear as prefixes for variable names. |
...
| Property | Default Value | Minimum Version | Summary |
| --- | --- | --- | --- |
| `topLevelTypes` | `[ "class", "interface", "struct", "enum", "delegate" ]` | 1.1.0 | Specifies which kind of types that should be placed in separate files |
...
| Property | Default Value | Minimum Version | Summary |
| --- | --- | --- | --- |
| `newlineAtEndOfFile` | `"require"` | 1.0.0 | Specifies the handling for newline characters which appear at the end of a file |
...
| Property | Default Value | Minimum Version | Summary |
| --- | --- | --- | --- |
| `companyName` | `"Bruno Coimbra Ribeiro"` | 1.0.0 | Specifies the company name which should appear in copyright notices |
...
| `xmlHeader` | **false** | 1.0.0 | Specifies whether file headers should use standard StyleCop XML format, where the copyright notice is wrapped in a `<copyright>` element |
...
| Property | Default Value | Minimum Version | Summary |
| --- | --- | --- | --- |
| `documentInterfaces` | **false** | 1.0.0 | Specifies whether interface members need to be documented. When true, all interface members require documentation, regardless of accessibility. |
...
| `documentInternalElements` | **false** | 1.0.0 | Specifies whether internal elements need to be documented. When true, all internally-exposed types and members require documentation. |
...
The analyzer will expect file names according the table below. When the `fileNamingConvention` property is not set, the `metadata` convention is used as default.
